...
- Estimation of the transition point (**m50**) is based on the **relative densities** (Bayes’ rule) of the classes given $x$, not discriminative regression
