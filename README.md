...
- `fit_stage()` – fit the STAGE model (single or multiple populations)  
- `transition_point()` – extract posterior summaries of m50  
- `predict.stage_fit()` – predict class probabilities or labels  
- `stage_priors()` – helper to set priors  
- `get_cmdstan_model()` – internal Stan compiler helper
