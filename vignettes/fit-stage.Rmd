...
For a single-population fit, this returns a list with a single element `global`: a named numeric vector
with posterior `mean`, `median`, `q2.5`, and `q97.5`.
...
- `global`: posterior summary of the global \(m_{50}\) (`mean`, `median`, `q2.5`, `q97.5`), and
