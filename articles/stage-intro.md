...
The **STAGE** model (**S**tate **T**ransition **A**nalysis via
**G**enerative **E**stimation)  
is a Bayesian generative classifier designed to estimate maturity or
transition points  
...
STAGE can be fit for a single population or hierarchically for multiple
populations.
...
This returns posterior summary statistics for the global transition
point (`m50`).
